...
register(
    id='FlockingSwarm-v0',
    entry_point='gym.envs.customized_envs:FlockingSwarmEnv', 
...
register(
    ...
    entry_point='gym.envs.customized_envs:PredatorPreySwarmEnv', 
    max_episode_steps=100,
    reward_threshold=1000.0,  
)

register(
    id='AdversarialSwarm-v0',
    entry_point='gym.envs.customized_envs:AdversarialSwarmEnv', 
    max_episode_steps=100,
    reward_threshold=1000.0,  
)

register(
    id='ComprehensionSwarm-v0',
    entry_point='gym.envs.customized_envs:ComprehensionSwarmEnv', 
    max_episode_steps=100,
    reward_threshold=1000.0,  
)
